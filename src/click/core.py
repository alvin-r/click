...
class Context:
    ...
    def __init__(
        ...
        if default_map is None and info_name is not None and parent is not None:
        ...
        if auto_envvar_prefix is None and parent and parent.auto_envvar_prefix is not None and self.info_name:
            auto_envvar_prefix = f"{parent.auto_envvar_prefix}_{self.info_name.upper()}".replace("-", "_")
        elif auto_envvar_prefix is not None:
